...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='/content/flower_dataset/train.txt',
        data_prefix='/content/flower_dataset/train',
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        ann_file='/content/flower_dataset/val.txt',
        classes=[
            'daisy',
            'dandelion',
            'rose',
        ...
        data_prefix='/content/flower_dataset/val',
        data_root='/content/flower_dataset',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(edge='short', scale=256, type='ResizeEdge'),
